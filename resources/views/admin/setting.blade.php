                ...
                {{ csrf_field() }}
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="current-pwd" class="col-sm-3 text-right control-label col-form-label">UserName</label>
                            <div class="col-sm-6">
                                <input value="{{ $adminDetails->username }}" class="form-control" readonly>
